		...
		<div className="patient__menu">
			...
			<div className="menu">
				<ul>
					...
					<li onClick={event => props.onChange(2)} style={props.isActive === 2 ? {color: "white", backgroundColor:"#408cfd"} : {}}><i className="bi bi-bag-check-fill" style={props.isActive === 2 ? {color: "white"} : {}}></i>Doctors</li>
